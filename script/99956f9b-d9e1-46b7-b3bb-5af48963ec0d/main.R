...
independent_variable <- params$mediation_file$independent_variable  |> trimws()
mediator <- params$mediation_file$mediator |> trimws()
outcome <- params$mediation_file$outcome |> trimws()
